...
import com.mrcrayfish.vehicle.entity.vehicle.EntityPolicePorsche;
 ...
 * Author: MrCrayfish
 */
public class RenderPolicePorsche extends AbstractRenderVehicle<EntityPolicePorsche>
{
    @Override
    public void render(EntityPolicePorsche entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.POLICE_PORSCHE_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityPolicePorsche entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
