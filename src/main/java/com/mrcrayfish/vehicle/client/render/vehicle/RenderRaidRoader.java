...
import com.mrcrayfish.vehicle.entity.vehicle.EntityRaidRoader;
 ...
 * Author: MrCrayfish
 */
public class RenderRaidRoader extends AbstractRenderVehicle<EntityRaidRoader>
{
    @Override
    public void render(EntityRaidRoader entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.RAID_ROADER_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityRaidRoader entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
