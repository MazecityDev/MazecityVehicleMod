...
import com.mrcrayfish.vehicle.entity.vehicle.EntityPoliceRoader;
 ...
 * Author: MrCrayfish
 */
public class RenderPoliceRoader extends AbstractRenderVehicle<EntityPoliceRoader>
{
    @Override
    public void render(EntityPoliceRoader entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.POLICE_ROADER_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityPoliceRoader entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
