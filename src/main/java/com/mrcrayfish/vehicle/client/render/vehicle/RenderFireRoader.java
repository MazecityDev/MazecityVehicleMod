...
import com.mrcrayfish.vehicle.entity.vehicle.EntityFireRoader;
 ...
 * Author: MrCrayfish
 */
public class RenderFireRoader extends AbstractRenderVehicle<EntityFireRoader>
{
    @Override
    public void render(EntityFireRoader entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.FIRE_ROADER_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntityFireRoader entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
