 ...
 * Author: MrCrayfish
 */
public class RenderBeautifulRoader extends AbstractRenderVehicle<EntityBeautifulRoader>
{
    @Override
    ...
    @Override
    public void applyPlayerModel(EntityBeautifulRoader entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
