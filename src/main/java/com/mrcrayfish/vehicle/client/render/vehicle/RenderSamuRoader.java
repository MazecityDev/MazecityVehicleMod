...
import com.mrcrayfish.vehicle.entity.vehicle.EntitySamuRoader;
 ...
 * Author: MrCrayfish
 */
public class RenderSamuRoader extends AbstractRenderVehicle<EntitySamuRoader>
{
    @Override
    public void render(EntitySamuRoader entity, float partialTicks)
    {
        this.renderDamagedPart(entity, SpecialModels.SAMU_ROADER_BODY.getModel());
    ...
    @Override
    public void applyPlayerModel(EntitySamuRoader entity, EntityPlayer player, ModelPlayer model, float partialTicks)
    {
