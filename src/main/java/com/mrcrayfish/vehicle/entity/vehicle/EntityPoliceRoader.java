 ...
 * Author: MrCrayfish
 */
public class EntityPoliceRoader extends EntityLandVehicle implements EntityRaytracer.IEntityRaytraceable
{
    /**
    ...
    public EntityPoliceRoader(World worldIn)
    {
        super(worldIn);
        this.setSize(2F, 1F);
    ...
    {
        super.onClientInit();
        body = new ItemStack(ModItems.POLICE_ROADER_BODY);
