 ...
 * Author: MrCrayfish
 */
public class EntitySamuRoader extends EntityLandVehicle implements EntityRaytracer.IEntityRaytraceable
{
    /**
    ...
    public EntitySamuRoader(World worldIn)
    {
        super(worldIn);
        this.setSize(2F, 1F);
    ...
    {
        super.onClientInit();
        body = new ItemStack(ModItems.SAMU_ROADER_BODY);
